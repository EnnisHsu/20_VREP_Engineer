...
FuzzyPID Pose_XAxis, Pose_YAxis, Pose_Yaw;
...
_chassis_Velocity* Controller_ChassisPositionLoop(const _chassis_GlobalPos* CurrentPose, const _chassis_GlobalPos* TargetPose)
{
	...
	Pose_XAxis.Target = myConstrain(TargetPose->x,-1000,1000);
	Pose_YAxis.Target = myConstrain(TargetPose->y,-1500,1500);
	...
	target_Velocity.x_speed = myConstrain(Pose_XAxis.Out,-100,100);
	target_Velocity.y_speed = myConstrain(Pose_YAxis.Out,-100,100);
